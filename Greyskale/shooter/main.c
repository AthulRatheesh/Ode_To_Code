...
// triangle is isosceles with common angles of 70 degrees.
...
void DrawGame(void)
{
    BeginDrawing();
        ...
        if (!gameOver)
        {
            ...
            for (int i = 0; i < MAX_BIG_METEORS; i++)
            {
                if (bigMeteor[i].active) DrawCircleV(bigMeteor[i].position, bigMeteor[i].radius, WHITE);
            ...
            if (victory) {DrawText("VICTORY", screenWidth/2 - MeasureText("VICTORY", 20)/2, screenHeight/2, 20, RED); DrawText("Made By Ashwin P Shine, Thank you for playing", GetScreenWidth() - MeasureText("Made By Ashwin P Shine, Thank you for playing",55)/2,GetScreenHeight() - 50,20, RED);}
            ...
            DrawText("Made By Ashwin P Shine, Thank you for playing", GetScreenWidth() - MeasureText("Made By Ashwin P Shine, Thank you for playing",55)/2,GetScreenHeight() - 50,20, RED);
        };
